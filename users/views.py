...
class UserPasswordResetView(PasswordResetView):
    ...
    def form_valid(self, form):
        if User.objects.filter(username=self.request.POST.get("username")).exists() and \
                User.objects.get(username=self.request.POST.get("username")).email == self.request.POST.get("email"):
