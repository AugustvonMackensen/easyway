...
def question_create(request):
    form = QuestionForm()
    return render(request, 'notice/question_form.html', {'form': form})
...
def answer_modify(request, answer_id):
    ...
    if request.user != answer.author:
        messages.error(request, '수정권한이 없습니다')
        return redirect('notice:detail', question_id=answer.question.id)
    if request.method == "POST":
    ...
    return render(request, 'notice/answer_form.html', context)
